...
export interface FadeLeftProps extends PropsWithChildren {
  className?: string;
  duration?: number;
  delay?: number;
...
export function FadeLeft({ children, className = "", duration = 0.55, delay = 0, viewport, once = true }: FadeLeftProps) {
