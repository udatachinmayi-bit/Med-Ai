...
const items = [
  ...
  { label: "Medicine scanner", href: "/medicine-scanner", icon: Pill },
  { label: "Report analyzer", href: "/report-analyzer", icon: FileText },
  { label: "Symptom checker", href: "/symptom-checker", icon: Stethoscope },
  { label: "Voice assistant", href: "/voice-assistant", icon: Mic },
  { label: "Health history", href: "/dashboard/history", icon: History },
...
export function Sidebar({
  ...
  return (
    <>
      <aside
        className={`sticky top-0 hidden h-screen shrink-0 flex-col border-r border-sky-100 bg-white/80 p-5 backdrop-blur-2xl transition-[width] duration-300 lg:flex ${
